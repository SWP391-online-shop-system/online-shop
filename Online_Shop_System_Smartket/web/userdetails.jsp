                            ...
                            <div class=" ">                                
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <div style="margin-left: 25px; margin-top: -10px;"><a href="userlist" style="color: white"><button class="btn btn-primary mb-1">Quay lại</button></a></div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="card mb-4">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <p class="text-muted mb-0"><%=(rs.getString("Address")==null)?"Chưa cập nhật":rs.getString("Address")%></p>
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <p class="text-muted mb-0"><%=(rs.getString("DateOfBirth")==null)?"Chưa cập nhật":rs.getString("DateOfBirth")%></p>
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <p class="text-muted mb-0"><%=(rs.getBoolean("Gender"))?"Nam":"Nữ"%></p>
                                                    </div>
                                                </div>
                                                    <hr>
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <select class="text-muted mb-0" name="roleUpdate" onchange="this.form.submit()" style="height: 33px;margin-top: -12px;">   
                                                            <option value="5" <%if(rs.getString("RoleID").equals("5")){%>selected<%}%>>Admin</option>                                                     
                                                            <option value="4" <%if(rs.getString("RoleID").equals("4")){%>selected<%}%>>Quản lí sale</option>                                                     
                                                            <option value="3" <%if(rs.getString("RoleID").equals("3")){%>selected<%}%>>Sale</option>                                                     
                                                            <option value="1" <%if(rs.getString("RoleID").equals("1")){%>selected<%}%>>Khách Hàng</option>                                                          
                                                            <option value="2" <%if(rs.getString("RoleID").equals("2")){%>selected<%}%>>Marketing</option>                                                            
                                                        </select></form>
                                                    </div>
                                                </div>
                                                <hr>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <form class="col-sm-8" id="myForm" method="get" action="userDetails">
