                                    ...
                                    <div class="table-responsive p-3">
                                        <form action="AddSlider" method="post" enctype='multipart/form-data' ">
                                            <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                                ...
                                                <%}%>
                                                <td><%=rsPro.getInt(1) + 1%></td>
                                                <input type="hidden" name ="userID1" value="${sessionScope.account.userID}">
                                                <td>${sessionScope.account.userID}</td>
                                                <td><input name="sliderImage1" type= "file"> <br>
                                                    <button type="submit">Tải lên</button></td>
                                                <td><textarea name="sliderLink1">${sliderLink1}</textarea></td>
                                                <input type="hidden" name ="createDate1" value="${sessionScope.timetoday}">
                                                <td>${sessionScope.timetoday}</td>
                                                <td><input type="radio" name="sliderStatus1" value="true" > hiện <br>
                                                    <input type="radio" name="sliderStatus1" value="false" checked> ẩn
                                                </td>
                                                </tr>
                                                </tbody>
                                            </table>
