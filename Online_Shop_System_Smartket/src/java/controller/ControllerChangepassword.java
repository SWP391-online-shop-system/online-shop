...
public class ControllerChangepassword extends HttpServlet {
    ...
    throws ServletException, IOException {
       ...
       if(!newPassword.equals(renewPassword)){
        ...
        User u= new User(user.getUserID(),user.getFirstName(),user.getLastLogin(),user.getAddress(),user.getPhoneNumber(),user.getDateOfBirth(),user.isGender(),user.getUserImage(),
