    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (url.endsWith(".jsp") && !url.contains("error404.jsp")) {
            ...
            if ((a.getRoleID() == 2 )|| a.getRoleID() == 3 || a.getRoleID() == 4 || a.getRoleID() == 5) {   
                if (url.startsWith("/blog") || url.startsWith("/cblog") 
                        || url.startsWith("/searchblog")
                        || url.startsWith("/ProductDetail") 
                        || url.startsWith("/searchPage") 
                        || url.startsWith("/MyOrder") 
                        || url.startsWith("/CartURL") || url.startsWith("/ProductListURL") 
                        || url.startsWith("/contactURL")) {
